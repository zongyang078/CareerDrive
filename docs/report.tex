...
\usepackage{setspace}
\usepackage{parskip}
\usepackage[scaled]{helvet}    % Arial-like font (Calibri not available in LaTeX)
...
% ── Custom title page ──────────────────────────────────────
\begin{center}
{\LARGE\textbf{CareerDrive: Maine Construction Industry\\[0.3em]
Career Map}}\\[0.6em]
\url{https://github.com/zongyang078/CareerDrive}
\end{center}
...
\caption{Supply-demand gap by cluster. Red bars indicate
...
component (PC1) explains 53.6\% of total variance and PC2
explains 9.0\%, reflecting high inherent structure in the
...
($k=3$). PC1 separates Management/Engineering from Entry Level
